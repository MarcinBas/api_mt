...
##### 2.1.1.2 Create an **[AWS account](https://aws.amazon.com/)**.
...
##### 2.2.1.1 Create a DeepL account [here](https://www.deepl.com/pro.html)
...
##### 2.3.1.1 Create a ModernMT account [here](https://www.modernmt.com/pricing/).
...
##### 2.4.1.1 To use this MT vendor you need to have your regular Google Account. Set it up and log in to it. Then log in [here](https://console.developers.google.com/cloud-resource-manager).
...
Refer to Point 2.1 for more information.

#### 4.1.2 How to set up the Memoq Translator Pro 9.8™ plugin for Amazon Translate (AWS) (for a local profile)
...
Refer to Point 2.2 for more information.
...
Refer to Point 2.3 for more information.
...
Refer to Point 2.4 for more information.
